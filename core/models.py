...
class Profile(models.Model):
    ...
    frame = models.CharField(max_length=30, null=True, default="bianchi")
    compo = models.CharField(max_length=30, null=True, default="slam")
    wheel = models.CharField(max_length=30, null=True, default="spinergy")
